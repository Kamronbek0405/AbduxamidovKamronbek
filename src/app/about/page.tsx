    ...
    return (
      <div className='bg-vilote w-full h-[100vh]'>
        <div className='container flex flex-col md:flex-row items-center justify-around md:gap-32 w-full h-full px-4 md:px-16'>
          ...
          <div className='w-full md:w-[400px] h-[300px] md:h-[400px] bg-[url("https://sinaps.uz/wp-content/uploads/2023/07/n1-pm-id-293-800x394.jpg")] bg-cover bg-no-repeat shadow-lg shadow-black'>
          </div>
        </div>
      </div>
    );
